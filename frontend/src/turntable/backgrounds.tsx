...
function BackgroundSVG() {
    return (
        ...
        <path id="etching1" className="etching" d="M759.109 482.98C783.209 441.238 750.648 407.4 686.382 407.4C622.116 407.4 550.481 441.238 526.382 482.98C502.282 524.722 534.843 558.561 599.109 558.561C663.375 558.561 735.009 524.722 759.109 482.98Z" pathLength={4} stroke="#F0F9FF" stroke-width="4" stroke-dasharray="1" mask="url(#path-14-inside-3_1_2)"/>
