...
function BackgroundSVG() {
    return (
        <svg width="1280" height="832" viewBox="0 0 1280 832" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-auto mr-auto w-full h-full">
        ...
        <path className="etching" d="M759.109 482.98C783.209 441.238 750.648 407.4 686.382 407.4C622.116 407.4 550.481 441.238 526.382 482.98C502.282 524.722 534.843 558.561 599.109 558.561C663.375 558.561 735.009 524.722 759.109 482.98Z" pathLength={4} stroke="#F0F9FF" stroke-width="4" stroke-dasharray="1" mask="url(#path-14-inside-3_1_2)"/>
        ...
        <path className="etching" d="M718.77 482.805C734.836 454.977 713.129 432.418 670.285 432.418C627.441 432.418 579.685 454.977 563.618 482.805C547.552 510.633 569.259 533.192 612.103 533.192C654.947 533.192 702.703 510.633 718.77 482.805Z" pathLength={4} stroke="#F0F9FF" stroke-width="4" stroke-dasharray="1" mask="url(#path-15-inside-4_1_2)"/>
        ...
        <g style={{ mixBlendMode: 'lighten' } as CSSProperties}>
        ...
        <g style={{ mixBlendMode: 'lighten' } as CSSProperties}>
        <circle cx="154.971" cy="267.327" r="44.2515" fill="#A78BFA"/>
        <circle cx="154.971" cy="267.327" r="44.2515" stroke="#F0F9FF" stroke-width="6"/>
        </g>
        ...
        <path d="M84.3275 163H273.333" stroke="#F0F9FF" stroke-width="6" stroke-linecap="round"/>
        <path d="M60.3672 204.182L84.0209 163" stroke="#F0F9FF" stroke-width="6" stroke-linecap="round"/>
        ...
        <g style={{ mixBlendMode: 'lighten' } as CSSProperties}>
        <circle cx="1102.97" cy="267.326" r="44.2507" fill="#A78BFA"/>
        <circle cx="1102.97" cy="267.326" r="44.2507" stroke="#F0F9FF" stroke-width="6"/>
        </g>
